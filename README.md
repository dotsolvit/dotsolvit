...
⚡I have independently completed a number of coursework on sensor control and module management, including remote control using a web server (HTML, CSS, JavaScript). Some works are available on GitHub: https://github.com/dotsolvit/ESP32_SearcherAStar,
